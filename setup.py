...
class Application(EventsAndKeyBindings):
    ...
    def app(self):
        ...
        # self.main_window.tk.call('wm', 'iconphoto', self.main_window._w, tk.PhotoImage(file='images/logo4.png'))
        ...
        self.Edit.add_command(label="       Replace..     Ctrl+R        ", command=self.replace)
        ...
        self.View.add_cascade(label="  Show Minimap   ", command=self.minimap_show_hide)
